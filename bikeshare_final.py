...
CITY_DATA = { 'chicago': 'chicago.csv',
              ...
              'washington': 'washhington.csv' }

def get_filters():
    """
    Asks user to specify city, month, and day to and analyze.

    Returns:
        (str) city -  name of the city to analyze
        (str) month - name of the month to filter by, or "all" to apply no month filter
        (str) day - name of the day of wek to filter by, or "all" to apply no day filter
    """
    ...
    while month not in month_options:
        month  =  input(""" please seleect the correct month:
    -january
    -february
    -march
    -april
